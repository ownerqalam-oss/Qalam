  ...
  return (
    <main className="min-h-screen bg-[#F7F1E8] text-[#46382F]">
      <section className="mx-auto max-w-[1180px] px-6 py-16 md:px-8">
        ...
        <div className="mb-12">
          ...
          {activeTag && (
            <div className="mt-6 flex items-center gap-3">
              <span
                className={`${inter.className} rounded-full bg-[#053400] px-4 py-1.5 text-xs font-medium text-white`}
              >
                #{activeTag}
              </span>
              ...
              <Link
                href="/journal"
                className={`${inter.className} text-xs font-medium text-[#81766D] hover:text-[#053400]`}
              >
                Clear filter ×
              </Link>
            </div>
        ...
        {!loading &&
          types.map((type) => {
            const posts = visibleArticles.filter((a) => a.type === type);
                        ...
                        <div className="mt-4 flex flex-wrap gap-2 pl-[100px]">
                          {post.tags.map((tag) => (
                            <Link
                              ...
                              className={`${inter.className} rounded-full bg-[#DCD4C9] px-3 py-1 text-xs text-[#46382F] transition hover:bg-[#053400] hover:text-white`}
                            >
                              #{tag}
                            </Link>
                          ))}
